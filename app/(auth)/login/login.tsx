...
const Login: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900 p-4">
      <div className="bg-gray-800 rounded-lg shadow-lg flex w-[1000px] overflow-hidden">
        ...
        <div className="w-1/2 bg-[#18404d] p-8 flex flex-col justify-center text-white rounded-r-lg relative">
          ...
          <div className="relative w-full overflow-hidden mt-6 h-[120px]">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="absolute w-full p-4 bg-white text-black rounded-lg"
              >
                <h4 className="font-semibold">
                  {messages[currentMessage].title}
                </h4>
                <p className="text-sm mt-2">{messages[currentMessage].text}</p>
              </motion.div>
            </AnimatePresence>
          </div>
        </div>
