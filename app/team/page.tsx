...
import { FiMail, FiMoreVertical, FiSearch, FiUser } from "react-icons/fi";
  ...
  return (
    <div className="p-6 space-y-6">
          ...
          <div className="flex-1 max-w-md">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700/50 py-2 pl-10 pr-4 text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
            </div>
          </div>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600 flex space-x-2">
                <button className="flex-1 flex items-center justify-center space-x-2 bg-blue-50 dark:bg-blue-600/20 text-blue-600 dark:text-blue-400 py-2 px-3 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-600/30 transition-colors">
                  <FiMail className="h-4 w-4" />
                  <span className="text-sm font-medium">Message</span>
                </button>
                <button className="flex-1 flex items-center justify-center space-x-2 bg-gray-100 dark:bg-gray-600/20 text-gray-700 dark:text-gray-300 py-2 px-3 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600/30 transition-colors">
      ...
      {filteredMembers.length === 0 && (
        <div className="bg-white dark:bg-gray-800/70 backdrop-blur-md rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
